...
def main():  # noqa: D103
    ...
    with tf.device('gpu:0'):
        ...
        dqn = DQNAgent(q_network, preprocessor, memory, policy, nb_actions, num_burn_in=5000, enable_double_dqn = True, enable_double_dqn_hw=False, reward_record=open('ddqn_reward.txt','w'), loss_record=open('ddqn_loss.txt','w')) ;
